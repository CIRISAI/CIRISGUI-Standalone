...
function Navbar({ className }: { className?: string }) {
  ...
  const visibleSystemNavigation = systemNavigation.filter(item => hasRole(item.minRole));
  const visibleAdminNavigation = adminNavigation.filter(item => hasRole(item.minRole));
  const visibleAccountNavigation = accountNavigation.filter(item => hasRole(item.minRole));

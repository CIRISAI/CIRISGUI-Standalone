    ...
    agent: {
      ...
      demos: [
        ...
        },
        {
          ...
          execute: () =>
            cirisClient.agent.interact("Hello from API demo!", { channel_id: "demo_channel" }),
    ...
    memory: {
      ...
      demos: [
        ...
        },
        {
          ...
          method: "GET" as const,
          execute: () =>
            cirisClient.memory.getVisualization({
              layout: "timeline",
              hours: 24,
              limit: 30,
            }),
    ...
    system: {
      ...
      demos: [
        ...
        },
        {
          ...
          method: "POST" as const,
          execute: () =>
            cirisClient.system.registerAdapter("cli", {
              enabled: true,
              priority: 2,
            }),
        ...
        },
        {
          ...
          method: "PUT" as const,
          execute: () =>
            cirisClient.system.updateServicePriority("memory_provider", {
              priority: "HIGH",
              priority_group: 0,
            }),
    ...
    telemetry: {
      ...
      demos: [
        ...
        },
        {
          ...
          method: "GET" as const,
          execute: () =>
            cirisClient.telemetry.getResourceHistory({
    ...
    audit: {
      ...
      demos: [
        ...
        },
        {
          ...
          method: "POST" as const,
          execute: () =>
            cirisClient.audit.searchEntries({
              service: "api",
              page_size: 5,
            }),
    ...
    wa: {
      ...
      demos: [
        ...
        },
        {
          ...
          method: "POST" as const,
          execute: () =>
            cirisClient.wiseAuthority.requestGuidance({
    ...
    users: {
      ...
      demos: [
        ...
        },
        {
          ...
          method: "PUT" as const,
          execute: () =>
            cirisClient.users.update("demo_user", {
              api_role: "ADMIN",
              is_active: true,
            }),
          params: {
        ...
        },
        {
          ...
          method: "PUT" as const,
          execute: () =>
            cirisClient.users.changePassword("admin", {
        ...
        },
        {
          ...
          method: "POST" as const,
          execute: () =>
            cirisClient.users.mintWiseAuthority("demo_user", {
              wa_role: "authority",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-lg text-gray-600">
            Interactive demonstration of all 150+ API endpoints across 12 modules
          </p>
        </div>
                    ...
                    >
                      <div className="flex justify-between items-start">
                        <div className="flex-1">
                          <h4 className="text-sm font-semibold text-gray-900">{demo.title}</h4>
                          ...
                          <div className="mt-2 flex items-center space-x-2">
                            ...
                            <code className="text-xs text-gray-500 font-mono">{demo.endpoint}</code>
                          </div>
                        </div>
                        <button
                          onClick={e => {

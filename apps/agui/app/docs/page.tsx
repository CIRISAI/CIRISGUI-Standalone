...
export default function DocsPage() {
  ...
  const documentation: Record<string, CategoryDoc> = {
    overview: {
      title: "API Overview",
      description:
        "CIRIS provides a comprehensive REST API with 150+ endpoints across 12 modules for agent interaction, system management, and observability.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-lg text-gray-600">
            Complete reference for all 150+ endpoints across 12 API modules
          </p>
        </div>
